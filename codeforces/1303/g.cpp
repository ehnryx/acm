...
ll get_ups(int u, int p, int d, ll s, ll r, const LineContainer& dat, vector<pair<ll,ll>>& out) {
	s += val[u];
	r += val[u] * d;
...
ll get_downs(int u, int p, int d, ll s, ll r, const LineContainer& dat, LineContainer& upd) {
	s += val[u];
	r += s;
